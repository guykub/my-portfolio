...
function Home() {
  return( 
    <section id='home' className='min-h-screen flex flex-col justify-center items-center lg:flex-row-reverse gap-9 lg:gap-16'>
    <div className='text-center z-10 px-4'>
        <img className='w-[200px] border-0 my-20 rounded-full shadow-lg shadow-gray-500/70 lg:m-0 lg:max-w[250px] object-cover object-bottom hover:translate-y-1 transition-all' src={profile} alt="Profile" />
    </div>
    <div className='text-center font-mono z-10 px-4'>
        ...
        <div className='flex justify-center items-center space-x-4'>
            ...
            <a className='bg-gradient-to-r flex flex-row from-teal-500 to-indigo-600 py-3 px-6 rounded hover:-translate-y-1 hover:shadow-[0_0_15px_[rgba(59,130,246,0.4)] font-medium transition relative overflow-hidden' href={resume} target='_blank'>
                <p>Resume</p>
            </a>
        </div>
    </div>
